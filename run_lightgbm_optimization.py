"""
LightGBM Optimization with Bayesian Search (Optuna)
Phase 1, Task 2: Optimize LightGBM for maximum performance
...
print("=" * 80)
print("LIGHTGBM OPTIMIZATION - PHASE 1, TASK 2")
print("=" * 80)
print(f"Start time: {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}")
print()
print("Objective: Optimize LightGBM with Bayesian search (Optuna)")
...
print("Training LightGBM with best parameters on full training set...")
...
with open('reports/lightgbm_optimization_results.json', 'w') as f:
    json.dump(results_data, f, indent=2)

print("✓ Results saved: reports/lightgbm_optimization_results.json")
print()
...
# LightGBM is typically robust, expect small negative gap
...
print("=" * 80)
print("NEXT STEP: Upload submission_lightgbm_optimized.csv to Kaggle")
print("=" * 80)
print()
